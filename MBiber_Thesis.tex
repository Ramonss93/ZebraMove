...
\includegraphics[scale=0.25]{Pictures/ubt_logo.jpg}
\end{minipage} \hfill
\begin{minipage}[c]{0.49\textwidth}
\flushright
\includegraphics[scale=0.97]{Pictures/GCE-Logo.JPG}
\end{minipage}
\vfill
...
\vfill
\includegraphics[width=\textwidth]{Pictures/4839394362_d252c7ec3e_b.jpg}
\end{center}
\vfill
...
%„Hiermit versichere ich, Matthias Biber, dass ich die vorliegende Arbeit selbstständig und unter Angabe aller Hilfsmittel und Referenzen angefertigt habe. Des Weiteren versichere ich, dass diese Arbeit in dieser oder ähnlicher Form noch keiner anderen Prüfungsbehörde vorgelegt wurde.“ \\
...
\input{Tables/summary_zebra_move_BWA.tex}
...
\input{Tables/summary_wdpa_BWA.tex}
...
\input{Tables/MLC_Percentage_WDPA_BWA.tex}
...
\input{Tables/Summary_migration_BWA.tex}
...
\input{Tables/summary_pvalue_BWA.tex}
...
\input{Tables/summary_zebra_move_KEN.tex}
...
\input{Tables/LU_percentage_KEN.tex}
...
\input{Tables/summary_wdpa_KEN.tex}
...
%\input{Tables/MLC_classes.tex}

\input{Tables/MLC_percentage_BWA.tex}

\input{Tables/summary_models_BWA.tex}

\input{Tables/summary_AIC_BWA.tex}

%\input{Tables/LU_classes.tex}

\input{Tables/MLC_percentage_KEN.tex}

%\input{Tables/MLC_Percentage_WDPA_KEN.tex}

\input{Tables/summary_akde_KEN.tex}
